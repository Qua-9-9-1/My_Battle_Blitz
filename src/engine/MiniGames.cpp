...
void Game::launchMenu() {
    std::vector<std::string> requiredFunctions = {
        "update",    "onP1Left", "onP1Right", "onP1Up",    "onP1Down", "onP2Left",
        "onP2Right", "onP2Up",   "onP2Down",  "onP1_1",    "onP1_2",   "onP1_3",
        "onP2_1",    "onP2_2",   "onP2_3",    "onP1Start", "onP2Start"};
...
int Game::loadMinigame(const std::string minigameName) {
    std::vector<std::string> requiredFunctions = {"update", "draw",     "onP1Left", "onP1Right",
                                                  "onP1Up", "onP1Down", "onP2Left", "onP2Right",
                                                  "onP2Up", "onP2Down", "onP1_1",   "onP1_2",
