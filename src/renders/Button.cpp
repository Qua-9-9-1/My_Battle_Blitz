...
void Button::setCentered() {
    ...
    _button.setOrigin(_button.getLocalBounds().width / 2.0f,
                      _button.getLocalBounds().height / 2.0f);
}
...
void Button::setBorder(float thickness) { _button.setOutlineThickness(thickness); }
...
void Button::centerText() {
    ...
    _text.setPosition(buttonBounds.left + buttonBounds.width / 2.0f,
